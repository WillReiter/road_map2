...
import numpy as np
from nowcasting.helpers.gifmaker import save_imgs_all
...
def save_hmw_imgs(im_dat, save_path):      ### be used
    """Save the HMW images to gif
    ...
    save_imgs_all(im_dat, prefix=save_path)
...
def save_hko_movie(im_dat, datetime_list, mask_dat=None, save_path="hko.mp4", masked=False,
    ...
    central_region = cfg.HMW.EVALUATION.CENTRAL_REGION
