...
if __name__ == '__main__':
    from nowcasting.hmw_evaluation import get_GDL, get_hit_miss_counts, get_balancing_weights
    from numpy.testing import assert_allclose, assert_almost_equal

    prediction = np.random.uniform(size=(10, 12, 1, 300, 300))
    truth = np.random.uniform(size=(10, 12, 1, 300, 300))
    mask = np.random.randint(low=0, high=2, size=(10, 12, 1, 300, 300)).astype(np.bool)
    import time
    ...
    #print(hits_numba, misses_numba, false_alarms_numba, correct_negatives_numba)
