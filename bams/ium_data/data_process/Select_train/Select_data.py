...
if __name__=="__main__":
    ...
    train_bj_iter = BJIterator(datetime_set="home/syao/Desktop/trajGRU/bams/ium_data/info/squence_len_25/bj_train_set.txt",
                               sample_mode="sequent", seq_len=25, width=600, height=600)
